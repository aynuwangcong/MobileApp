...
<div class="container-fluid0">
    <div region="north" style="height: 100px;background-image: url('${pageContext.request.contextPath}/images/bg.jpg')">
        <div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >学生查重管理系统</font></div>
    ...
    <div class="row-fluid">
        <div class="bs-docs-sidebar" >
            <ul class="bs-docs-sidenav">
                ...
                <li><a href="${pageContext.request.contextPath}/student/querystudent">学生信息管理系统<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/students/querystudent">个人学习信息统计<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/classes/querystudent">班级学习信息统计<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/student/preload">提交作业<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/student/preduplicate">作业查重<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/student/preupdatepassage">修改密码<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="<c:url value='/index.jsp'/>">退出系统<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
            </ul>
        </div>
