...
<form class="file1" action="${pageContext.request.contextPath}/student/duplicate" method="post" enctype="multipart/form-data" >
    <button type="submit" class="btn btn-large btn-primary">查重</button>
</form>
</body>
</html>
